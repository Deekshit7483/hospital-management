...
public class AllAppointmentActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.all_appointment);
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			linear1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					i.putExtra("key", appointment_list.get((int)_position).get("key").toString());
					i.putExtra("doctor name", appointment_list.get((int)_position).get("doctor name").toString());
					i.putExtra("user name", appointment_list.get((int)_position).get("user name").toString());
					i.putExtra("fees", appointment_list.get((int)_position).get("fees").toString());
