...
public class ProfileActivity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> doctors = new ArrayList<>();
		...
		_user_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					...
					textview2.setText(_childValue.get("username").toString());
					textview3.setText(_childValue.get("phone").toString());
					textview4.setText(_childValue.get("gender").toString());
					textview5.setText(_childValue.get("email").toString());
	...
	private void initializeLogic() {
		if (getIntent().getStringExtra("profile ").equals("true")) {
