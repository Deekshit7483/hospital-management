...
public class BookAppointmentActivity extends AppCompatActivity {
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			if (list.get((int)_position).containsKey("username")) {
				textview1.setText(list.get((int)_position).get("username").toString());
			}
			if (list.get((int)_position).containsKey("fees")) {
				textview2.setText(list.get((int)_position).get("fees").toString());
			}
			if (list.get((int)_position).containsKey("specification")) {
				textview3.setText(list.get((int)_position).get("specification").toString());
			}
			if (list.get((int)_position).containsKey("address")) {
				textview4.setText(list.get((int)_position).get("address").toString());
			}
			linear1.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					i.setClass(getApplicationContext(), BookAppointment1Activity.class);
					i.putExtra("username", list.get((int)_position).get("username").toString());
					i.putExtra("fees", list.get((int)_position).get("fees").toString());
					i.putExtra("specification", list.get((int)_position).get("specification").toString());
					i.putExtra("address", list.get((int)_position).get("address").toString());
					i.putExtra("uid", list.get((int)_position).get("uid").toString());
					startActivity(i);
				}
			});
