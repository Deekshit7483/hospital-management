...
public class ProfileDActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.profile_d);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), EditProfileDActivity.class);
				startActivity(i);
			}
		});
		...
		_doctor_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					...
					textview2.setText(_childValue.get("phone").toString());
					textview3.setText(_childValue.get("email").toString());
					textview4.setText(_childValue.get("fees").toString());
					textview5.setText(_childValue.get("specification").toString());
