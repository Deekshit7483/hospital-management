...
public class Payment1Activity extends AppCompatActivity {
	...
	private void initializeLogic() {
		textview1.setText(getIntent().getStringExtra("doctor name"));
		textview2.setText(getIntent().getStringExtra("fees"));
		textview3.setText(getIntent().getStringExtra("user name"));
	}
