	...
	private void initialize(Bundle _savedInstanceState) {
						...
						if (!codes.getText().toString().equals("")) {
							if (code.equals("")) {
								...
								if (codes.getText().toString().equals(code)) {
									fauth_d.signInWithEmailAndPassword(email.getText().toString(), password.getText().toString()).addOnCompleteListener(LoginDocActivity.this, _fauth_d_sign_in_listener);
								}
								else {
									SketchwareUtil.showMessage(getApplicationContext(), "invalid code");
								}
		...
		textview4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (email.getText().toString().equals("")) {
					...
					fauth_d.sendPasswordResetEmail(email.getText().toString()).addOnCompleteListener(_fauth_d_reset_password_listener);
				}
			}
		});
		...
		textview3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				i.setData(Uri.parse("mailto:darshhhgowda2000@gmail.com"));
				startActivity(i);
			}
		});
