...
public class LoginPaActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.login_pa);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				fauth_p.signInWithEmailAndPassword(edittext1.getText().toString(), edittext2.getText().toString()).addOnCompleteListener(LoginPaActivity.this, _fauth_p_sign_in_listener);
			}
		});
		...
		textview2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (edittext1.getText().toString().equals("")) {
					...
					fauth_p.sendPasswordResetEmail(edittext1.getText().toString()).addOnCompleteListener(_fauth_p_reset_password_listener);
				}
			}
		});
		...
		_fauth_p_reset_password_listener = new OnCompleteListener<Void>() {
			...
			public void onComplete(Task<Void> _param1) {
				final boolean _success = _param1.isSuccessful();
				if (_success) {
					SketchwareUtil.showMessage(getApplicationContext(), "link Sent ");
				}
				else {
					SketchwareUtil.showMessage(getApplicationContext(), "link not sent");
				}
			}
		};
	}
